<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-sm text-gray-500">Tambah materi pelatihan</p>
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">Materi Pelatihan Baru</h2>
            </div>
    ...
    <div class="py-10">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="card">
                <form method="POST" action="{{ route('trainings.store') }}" class="space-y-6" enctype="multipart/form-data">
                    @csrf
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="trainer" name="trainer" type="text" class="mt-1 block w-full" :value="old('trainer')" />
                        ...
                        <div class="flex items-center gap-3 mt-6">
                            <input id="is_mandatory" name="is_mandatory" type="checkbox" value="1" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" @checked(old('is_mandatory'))>
